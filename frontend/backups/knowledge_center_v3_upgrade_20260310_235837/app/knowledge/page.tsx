...
export default function KnowledgePage() {
  ...
  }, [documents, searchTerm, statusFilter, languageFilter])
    ...
    <div className="space-y-6">
      <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <p className="mt-1 text-sm text-slate-500">
          ניהול קורסים, הרצאות, מרצים, מסמכים ועיבוד ידע
        </p>
      </section>

      <section className="grid grid-cols-2 gap-4 md:grid-cols-4">
        <div className="rounded-2xl border bg-white p-4 shadow-sm">
          <div className="text-sm text-slate-500">סה״כ מסמכים</div>
          <div className="mt-1 text-2xl font-semibold">{stats.total}</div>
        </div>
        <div className="rounded-2xl border bg-white p-4 shadow-sm">
          <div className="text-sm text-slate-500">מוכנים</div>
          <div className="mt-1 text-2xl font-semibold text-emerald-700">{stats.ready}</div>
        </div>
        <div className="rounded-2xl border bg-white p-4 shadow-sm">
          <div className="text-sm text-slate-500">בעיבוד</div>
          <div className="mt-1 text-2xl font-semibold text-amber-700">{stats.processing}</div>
        </div>
        <div className="rounded-2xl border bg-white p-4 shadow-sm">
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-3">
        ...
        <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
          <h3 className="mb-4 text-lg font-semibold">העלאת מסמכים</h3>
      ...
      <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <div className="mb-4 grid grid-cols-1 gap-3 md:grid-cols-4">
          <input
            ...
            placeholder="חפש מסמך, נושא או הרצאה"
            value={searchTerm}
      ...
      {documentDetails && (
        <Modal title={`פרטי מסמך: ${documentDetails.file_name}`} onClose={() => setDocumentDetails(null)}>
