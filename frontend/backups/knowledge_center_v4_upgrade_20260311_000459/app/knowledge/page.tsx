...
export default function KnowledgePage() {
  ...
  const filteredDocuments = useMemo(() => {
    const filtered = documents.filter((doc) => {
      ...
      return matchesSearch && matchesStatus && matchesLanguage && matchesSourceType && matchesLecture
    })
  ...
  }, [documents, searchTerm, statusFilter, languageFilter, sourceTypeFilter, lectureFilter, sortBy])
