    ...
    <div className="space-y-5">
      <section className="rounded-3xl border border-slate-200 bg-white p-4 shadow-sm">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <TabButton tab="courses" label="קורסים, הרצאות ומרצים" />
      ...
      {activeTab === "courses" && (
        <div className="grid grid-cols-1 gap-6 xl:grid-cols-4">
                ...
                {filteredLecturers.map((lecturer) => (
                  <div key={lecturer.id} className="rounded-2xl border border-slate-200 p-3">
                    ...
                    <div className="mt-3 flex gap-2">
                      ...
                      <button onClick={() => deleteLecturer(lecturer.id)} className="rounded-lg bg-red-100 px-3 py-1 text-sm text-red-700">
                        מחק
                      </button>
                    </div>
                  </div>
          ...
          <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
            <h3 className="mb-4 text-lg font-semibold">הוספת מרצה / העלאת מסמכים</h3>
